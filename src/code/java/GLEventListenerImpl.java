...
public class GLEventListenerImpl implements GLEventListener{
    ...
    private void initializeModels (GL3 gl) {
        ...
        GLSkyBoxModel skyBoxModel = new GLSkyBoxModel(gl, canvas);
        modelList.add(skyBoxModel);
        ...
        GLSphereCollision sphereCollision = new GLSphereCollision(new Point3f(-4f, 0.0f, 0.0f), 1f);
        model = new GLCam(gl, subtractor, "player1.obj", camShader, -4f, sphereCollision);
        model.setModelMatrixOffset(-4f, 0.0f, 0.0f);
        modelList.add(model);
        collision = new GLSphereCollision(new Point3f(-4f, 0.0f, 0.0f), 1f);
